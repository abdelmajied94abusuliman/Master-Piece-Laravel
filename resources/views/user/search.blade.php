...
<body>
    <div id="container-filter-apartment">
        <div id="container-icon-and-search">
            <form action="{{ route('search') }}" method="get" class="div-bar">
                @csrf
                <input type="text" name="search" class="search" id="search-bar" value="{{isset($search) ? $search : ''}}" placeholder="Search...">
            </form>
    ...
    <div class="pagination">
        {{ $allItems->appends(['search' => $search])->links()}}
    </div>
